...
6) **Convex sets and convex functions:** Sets can be convex or concave. Functions can be convex, concave, or both, or neither. If fucntion f is convex, then -f is concave. In this post, we examine conditions for functions to be convex. Convex functions are important for a large class of optimization problems. 
